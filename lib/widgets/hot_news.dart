...
import 'package:news_app/bloc/gethotnews_bloc.dart';
...
import '../model/ariticle.dart';
import '../screens/detailsnews.dart';
...
class _HotNewsWidgetState extends State<HotNewsWidget> {
  ...
  Widget _buildHotNewsWidget(AritcalResponse data) {
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: articles[index].img == null ? AssetImage("aseets/img/mm.jpg") : NetworkImage(articles[index].img) as ImageProvider,
                                  fit: BoxFit.cover
                              )
                          ),
